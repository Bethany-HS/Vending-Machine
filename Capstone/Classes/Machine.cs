...
namespace Capstone.Classes
{
    public class Machine
    {
        ...
        public Dictionary<string, Snacks> Inventory { get; set; } //private set
        ...
        {
            //doesn't neeed to check Inventory.ContainsKeyuserEnteredCode, because the UI already checked this
            if (Inventory.ContainsKey(userEnteredCode) && Inventory[userEnteredCode].SnackQuantity > 0)
            {
                ...
                Inventory[userEnteredCode] = selectedSnack; //check later
